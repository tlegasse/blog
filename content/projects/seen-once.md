...
There *are* many platforms out there that offer services to send encrypted credentials back and forth, but they typically require an account to use or recieve, and often required paid services. There used to be a service called dead-drop.me that I really enjoyed, but the author decided no longer to maintain it. Over the years, I've really wanted to build my own and build tools that make security fun.
